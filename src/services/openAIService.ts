...
/**
 * Génère un fichier audio à partir de texte avec l'API OpenAI TTS
 */
export async function generateSpeech(
  ...
  try {
    ...
    onProgress?.(50, "Génération de l'audio en cours...");
    ...
    throw new Error("Une erreur inconnue s'est produite lors de la synthèse vocale");
  }
}
